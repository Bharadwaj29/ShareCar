      ...
      <div class="container-fluid" id="myContainer">
          <div class="row">
              <div class="col-md-6 col-md-offset-3">
                  <h1>Welocme to Car Sharing Website!</h1>
                  <p class="lead">Plan your next trip now!</p>
                  <p class="bold">Save Money! Save the Environment! Stay Safe!
                  </p>
              </div>
                  <!--Search Form-->
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  ...
                  <h4 id="myModalLabel">
                    Sign up today and Start using our Online Car Sharing App! 
                  </h4>
              </div>
              <div class="modal-body">
